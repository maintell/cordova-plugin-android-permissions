cordova.define("cordova-plugin-android-permissions.Permissions", function (
    require,
    exports,
    module
) {
    ...
    Permissions.prototype = {
        ...
        dnd: function (mode, successCallback, errorCallback) {
            cordova.exec(
                successCallback,
                errorCallback,
                permissionsName,
        ...
        openAppStart: function (mode, successCallback, errorCallback) {
            cordova.exec(
                successCallback,
                errorCallback,
                permissionsName,
        ...
        KeepScreenWakeOn: function (mode, successCallback, errorCallback) {
            cordova.exec(
                successCallback,
                errorCallback,
                permissionsName,
        ...
        clearScreenWakeOn: function (mode, successCallback, errorCallback) {
            cordova.exec(
                successCallback,
                errorCallback,
                permissionsName,
